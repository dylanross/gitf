...
{	
	...
	public CharacterSheetGenerator getCharacterSheetGenerator();	// returns a CharacterSheetGenerator that can be used to 
																	// produce a character sheet for this character
